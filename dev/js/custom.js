	...
	$(document).ready(function() {
		...
		$.scrollUp = function (options) {
			...
			if (o.activeOverlay) {
				...
				$(scrollId+"-active").css({ 'position': 'absolute', 'top': o.topDistance+'px', 'width': '100%',
                    'border-top': '1px dotted '+o.activeOverlay, 'z-index': '2147483647' });
			}
			// Scroll function
			$(window).scroll(function(){
				switch (o.animation) {
        ...
        $(".next").click(function(){
            works.trigger('owl.next');
        })
        $(".prev").click(function(){
            works.trigger('owl.prev');
        })
		/*----------------------------------------------------*/
		/*	Statistic Counter
		/*----------------------------------------------------*/
					...
					$(".message").html("<span style='color:#eee;'>Adding your email address...</span>");
						...
						success: function(msg) {
							if(msg=="success")
								...
								{
									$(".message").html("<span style='color:red;'>The email address you entered was invalid. " +
                                        "Please make sure you enter a valid email address to subscribe.</span>");
								}
						}
					});
				}
